...
const GAME_MESSAGES = {
  ...
  'event.career.adult_jealous': { en: 'Your partner has been texting a "friend" a lot lately. You feel jealous.', ar: 'Your partner has been texting a "friend" a lot lately. You feel jealous. AR' },
  ...
  'event.career.adult_jealous.outcome.0': { en: 'They were just planning your surprise party. Oops.', ar: 'They were just planning your surprise party. Oops. AR' },
  'event.career.adult_jealous.outcome.1': { en: 'It eats at you all year.', ar: 'It eats at you all year. AR' },
  'event.career.adult_marathon': { en: 'You decided to run a marathon. You trained for months.', ar: 'You decided to run a marathon. You trained for months. AR' },
  'event.career.adult_midlife_crisis': { en: 'You are having a midlife crisis. You bought a red convertible.', ar: 'You are having a midlife crisis. You bought a red convertible. AR' },
  'event.career.adult_side_hustle': { en: 'A friend wants you to invest in their startup. It is a phone case that doubles as a wallet.', ar: 'A friend wants you to invest in their startup. It is a phone case that doubles as a wallet. AR' },
  ...
  'event.career.adult_side_hustle.outcome.0': { en: 'It actually took off! You made $2000 back.', ar: 'It actually took off! You made $2000 back. AR' },
  'event.career.adult_side_hustle.outcome.1': { en: 'You missed the next big thing.', ar: 'You missed the next big thing. AR' },
  'event.career.adult_therapy': { en: 'Your therapist says you have made great progress. But your insurance won\'t cover the next session.', ar: 'Your therapist says you have made great progress. But your insurance won\'t cover the next session. AR' },
  ...
  'event.career.adult_therapy.outcome.0': { en: 'Your mental health is worth it.', ar: 'Your mental health is worth it. AR' },
  'event.career.adult_therapy.outcome.1': { en: 'You will be fine. Probably.', ar: 'You will be fine. Probably. AR' },
  'event.career.child_bake_sale': { en: 'Your school is having a bake sale. Do you want to help?', ar: 'Your school is having a bake sale. Do you want to help? AR' },
  ...
  'event.career.child_bake_sale.outcome.0': { en: 'You sold out in an hour!', ar: 'You sold out in an hour! AR' },
  'event.career.child_bake_sale.outcome.1': { en: 'You ate six cupcakes. Worth it.', ar: 'You ate six cupcakes. Worth it. AR' },
  'event.career.child_bedwetting': { en: 'You wet the bed at a sleepover. So embarrassing.', ar: 'You wet the bed at a sleepover. So embarrassing. AR' },
  'event.career.child_grounded': { en: 'You broke a vase playing ball inside. You are grounded for a week.', ar: 'You broke a vase playing ball inside. You are grounded for a week. AR' },
  'event.career.child_penpal': { en: 'You got a pen pal from Japan! You write letters every month.', ar: 'You got a pen pal from Japan! You write letters every month. AR' },
  'event.career.child_pet_fish': { en: 'You won a goldfish at the fair! You named it George.', ar: 'You won a goldfish at the fair! You named it George. AR' },
  'event.career.child_piano': { en: 'You started piano lessons. Your fingers hurt but it sounds nice.', ar: 'You started piano lessons. Your fingers hurt but it sounds nice. AR' },
  'event.career.child_rollercoaster': { en: 'Your family went to an amusement park! You rode the biggest rollercoaster.', ar: 'Your family went to an amusement park! You rode the biggest rollercoaster. AR' },
  'event.career.child_sport': { en: 'Your parents signed you up for soccer! You hate it.', ar: 'Your parents signed you up for soccer! You hate it. AR' },
  'event.career.elder_grandchild': { en: 'Your child had a baby! You are a grandparent now!', ar: 'Your child had a baby! You are a grandparent now! AR' },
  'event.career.elder_health_scare': { en: 'You had a health scare. The doctors say you need to take it easy.', ar: 'You had a health scare. The doctors say you need to take it easy. AR' },
  'event.career.elder_reminsice': { en: 'You find an old photo album and spend the afternoon reminiscing.', ar: 'You find an old photo album and spend the afternoon reminiscing. AR' },
  'event.career.elder_will_update': { en: 'Your lawyer recommends updating your will.', ar: 'Your lawyer recommends updating your will. AR' },
  ...
  'event.career.elder_will_update.outcome.0': { en: 'Peace of mind. Your affairs are in order.', ar: 'Peace of mind. Your affairs are in order. AR' },
  'event.career.elder_will_update.outcome.1': { en: 'You will do it next year. Probably.', ar: 'You will do it next year. Probably. AR' },
  'event.career.elder_wisdom': { en: 'You feel a sense of clarity. Life is good. You write down your thoughts.', ar: 'You feel a sense of clarity. Life is good. You write down your thoughts. AR' },
  'event.career.fame_fan_encounter': { en: 'A fan approaches you in a restaurant and asks for a selfie.', ar: 'A fan approaches you in a restaurant and asks for a selfie. AR' },
  ...
  'event.career.fame_fan_encounter.outcome.0': { en: 'You made their day!', ar: 'You made their day! AR' },
  'event.career.fame_fan_encounter.outcome.1': { en: 'They understood. Mostly.', ar: 'They understood. Mostly. AR' },
  'event.career.fame_haters': { en: 'A gossip site published a story about you. It is completely false.', ar: 'A gossip site published a story about you. It is completely false. AR' },
  ...
  'event.career.fame_haters.outcome.0': { en: 'The controversy made you more famous.', ar: 'The controversy made you more famous. AR' },
  'event.career.fame_haters.outcome.1': { en: 'You won the lawsuit! Headlines everywhere.', ar: 'You won the lawsuit! Headlines everywhere. AR' },
  'event.career.fame_haters.outcome.2': { en: 'Not your finest moment.', ar: 'Not your finest moment. AR' },
  'event.career.ma_annual_checkup': { en: 'You are due for your annual physical. You have been avoiding it.', ar: 'You are due for your annual physical. You have been avoiding it. AR' },
  ...
  'event.career.ma_annual_checkup.outcome.0': { en: 'Clean bill of health. What a relief!', ar: 'Clean bill of health. What a relief! AR' },
  'event.career.ma_annual_checkup.outcome.1': { en: 'Ignorance is bliss.', ar: 'Ignorance is bliss. AR' },
  'event.career.ma_back_pain': { en: 'You threw your back out by sneezing. Getting old is humbling.', ar: 'You threw your back out by sneezing. Getting old is humbling. AR' },
  'event.career.ma_empty_nest': { en: 'Your last child moved out. The house feels so quiet now.', ar: 'Your last child moved out. The house feels so quiet now. AR' },
  'event.career.ma_family_reunion': { en: 'Your extended family is organizing a reunion. You have not seen some of them in years.', ar: 'Your extended family is organizing a reunion. You have not seen some of them in years. AR' },
  ...
  'event.career.ma_family_reunion.outcome.0': { en: 'Aunt Karen was there. So was the good potato salad. Worth it.', ar: 'Aunt Karen was there. So was the good potato salad. Worth it. AR' },
  'event.career.ma_family_reunion.outcome.1': { en: 'You ordered pizza and watched TV instead. Peaceful.', ar: 'You ordered pizza and watched TV instead. Peaceful. AR' },
  'event.career.ma_glasses': { en: 'You have been squinting at menus. It is time for reading glasses.', ar: 'You have been squinting at menus. It is time for reading glasses. AR' },
  'event.career.ma_health_scare': { en: 'Your doctor says your cholesterol is high and your blood pressure is concerning.', ar: 'Your doctor says your cholesterol is high and your blood pressure is concerning. AR' },
  'event.career.ma_health_scare.choice.0': { en: 'Change diet and exercise', ar: 'Change diet and exercise AR' },
  'event.career.ma_health_scare.choice.1': { en: 'Ignore it', ar: 'Ignore it AR' },
  'event.career.ma_health_scare.outcome.0': { en: 'A year later, your numbers are perfect. Feel amazing!', ar: 'A year later, your numbers are perfect. Feel amazing! AR' },
  'event.career.ma_health_scare.outcome.1': { en: 'Ignorance is bliss until it is not.', ar: 'Ignorance is bliss until it is not. AR' },
  'event.career.ma_high_school_reunion': { en: 'Your high school reunion is coming up. Do you go?', ar: 'Your high school reunion is coming up. Do you go? AR' },
  'event.career.ma_high_school_reunion.choice.0': { en: 'Go and show off', ar: 'Go and show off AR' },
  'event.career.ma_high_school_reunion.choice.1': { en: 'Skip it', ar: 'Skip it AR' },
  'event.career.ma_high_school_reunion.outcome.0': { en: 'You are doing way better than most of them. Feels good.', ar: 'You are doing way better than most of them. Feels good. AR' },
  'event.career.ma_high_school_reunion.outcome.1': { en: 'Living well is the best revenge.', ar: 'Living well is the best revenge. AR' },
  'event.career.ma_home_maintenance': { en: 'The water heater broke and the basement is flooding.', ar: 'The water heater broke and the basement is flooding. AR' },
  'event.career.ma_inheritance': { en: 'A distant aunt you barely remember passed away and left you something.', ar: 'A distant aunt you barely remember passed away and left you something. AR' },
  ...
  'event.career.ma_inheritance.outcome.0': { en: 'She always liked you best.', ar: 'She always liked you best. AR' },
  'event.career.ma_inheritance.outcome.1': { en: 'It is not worth much, but the sentimental value is priceless.', ar: 'It is not worth much, but the sentimental value is priceless. AR' },
  'event.career.ma_kids_activities': { en: 'Your child wants to join an expensive extracurricular activity.', ar: 'Your child wants to join an expensive extracurricular activity. AR' },
  ...
  'event.career.ma_kids_activities.outcome.0': { en: 'They loved it! You are their favorite parent.', ar: 'They loved it! You are their favorite parent. AR' },
  'event.career.ma_kids_activities.outcome.1': { en: 'They understood, but you feel guilty.', ar: 'They understood, but you feel guilty. AR' },
  'event.career.ma_mentor_junior': { en: 'Your company asked you to mentor a junior employee. They look up to you.', ar: 'Your company asked you to mentor a junior employee. They look up to you. AR' },
  'event.career.ma_neighbor_dispute': { en: 'Your new neighbor blasts music at 2 AM every night.', ar: 'Your new neighbor blasts music at 2 AM every night. AR' },
  'event.career.ma_neighbor_dispute.choice.0': { en: 'Talk to them nicely', ar: 'Talk to them nicely AR' },
  'event.career.ma_neighbor_dispute.choice.1': { en: 'Call the police', ar: 'Call the police AR' },
  'event.career.ma_neighbor_dispute.outcome.0': { en: 'They apologized! They did not realize the walls were thin.', ar: 'They apologized! They did not realize the walls were thin. AR' },
  'event.career.ma_neighbor_dispute.outcome.1': { en: 'Now they glare at you in the hallway. Worth it.', ar: 'Now they glare at you in the hallway. Worth it. AR' },
  'event.career.ma_new_hobby': { en: 'You have been feeling stagnant. Maybe it is time for a new hobby.', ar: 'You have been feeling stagnant. Maybe it is time for a new hobby. AR' },
  ...
  'event.career.ma_new_hobby.outcome.0': { en: 'You have an eye for it! Friends love your photos.', ar: 'You have an eye for it! Friends love your photos. AR' },
  'event.career.ma_new_hobby.outcome.1': { en: 'Your tomatoes are the envy of the neighborhood.', ar: 'Your tomatoes are the envy of the neighborhood. AR' },
  'event.career.ma_new_hobby.outcome.2': { en: 'The routine consumes you again.', ar: 'The routine consumes you again. AR' },
  'event.career.ma_old_friend': { en: 'An old friend from high school just moved back to town. They want to catch up.', ar: 'An old friend from high school just moved back to town. They want to catch up. AR' },
  ...
  'event.career.ma_old_friend.outcome.0': { en: 'It felt like no time had passed. Great night.', ar: 'It felt like no time had passed. Great night. AR' },
  'event.career.ma_old_friend.outcome.1': { en: 'You keep saying you will call. You never do.', ar: 'You keep saying you will call. You never do. AR' },
  'event.career.ma_parenting_milestone': { en: 'Your child just performed in their first school play. You cried a little.', ar: 'Your child just performed in their first school play. You cried a little. AR' },
  'event.career.ma_refinance': { en: 'Interest rates dropped. A great time to refinance your mortgage.', ar: 'Interest rates dropped. A great time to refinance your mortgage. AR' },
  'event.career.ma_refinance.choice.0': { en: 'Refinance', ar: 'Refinance AR' },
  'event.career.ma_refinance.choice.1': { en: 'Not worth the hassle', ar: 'Not worth the hassle AR' },
  'event.career.ma_refinance.outcome.0': { en: 'Your monthly payment dropped significantly. Financial win!', ar: 'Your monthly payment dropped significantly. Financial win! AR' },
  'event.career.ma_refinance.outcome.1': { en: 'You missed the rate window.', ar: 'You missed the rate window. AR' },
  'event.career.ma_renew_vows': { en: 'Your anniversary is coming up. You want to do something special.', ar: 'Your anniversary is coming up. You want to do something special. AR' },
  'event.career.ma_renew_vows.choice.0': { en: 'Renew your vows', ar: 'Renew your vows AR' },
  'event.career.ma_renew_vows.choice.1': { en: 'Quiet dinner at home', ar: 'Quiet dinner at home AR' },
  'event.career.ma_renew_vows.outcome.0': { en: 'It was beautiful. Your partner cried. You cried. Everyone cried.', ar: 'It was beautiful. Your partner cried. You cried. Everyone cried. AR' },
  'event.career.ma_renew_vows.outcome.1': { en: 'Sometimes simple is best.', ar: 'Sometimes simple is best. AR' },
  'event.career.ma_volunteering': { en: 'A local shelter is looking for volunteers. You have some free weekends.', ar: 'A local shelter is looking for volunteers. You have some free weekends. AR' },
  ...
  'event.career.ma_volunteering.outcome.0': { en: 'Giving back fills a void you did not know you had.', ar: 'Giving back fills a void you did not know you had. AR' },
  'event.career.ma_volunteering.outcome.1': { en: 'Maybe another time.', ar: 'Maybe another time. AR' },
  'event.career.mil_deployment': { en: 'You have been ordered to deploy to a combat zone.', ar: 'You have been ordered to deploy to a combat zone. AR' },
  ...
  'event.career.mil_deployment.outcome.0': { en: 'You returned home safe with a medal.', ar: 'You returned home safe with a medal. AR' },
  'event.career.mil_deployment.outcome.1': { en: 'You went AWOL and are now a fugitive.', ar: 'You went AWOL and are now a fugitive. AR' },
  'event.career.music_flop': { en: 'Your experimental jazz album was a total flop.', ar: 'Your experimental jazz album was a total flop. AR' },
  'event.career.music_hit': { en: 'Your latest single is climbing the charts!', ar: 'Your latest single is climbing the charts! AR' },
  'event.career.music_tour': { en: 'Your label wants you to go on a World Tour.', ar: 'Your label wants you to go on a World Tour. AR' },
  ...
  'event.career.music_tour.outcome.0': { en: 'Sold out stadiums! You\'re exhausted but rich.', ar: 'Sold out stadiums! You\'re exhausted but rich. AR' },
  'event.career.music_tour.outcome.1': { en: 'You worked on new music instead.', ar: 'You worked on new music instead. AR' },
  'event.career.pet_sick': { en: 'Your pet is acting strange. Might be sick.', ar: 'Your pet is acting strange. Might be sick. AR' },
  ...
  'event.career.pet_sick.outcome.0': { en: 'Just a stomach bug. They are fine!', ar: 'Just a stomach bug. They are fine! AR' },
  'event.career.pet_sick.outcome.1': { en: 'They recovered on their own, luckily.', ar: 'They recovered on their own, luckily. AR' },
  'event.career.pet_tricks': { en: 'Your pet learned a new trick! They can roll over and play dead.', ar: 'Your pet learned a new trick! They can roll over and play dead. AR' },
  'event.career.poverty_eviction': { en: 'You are behind on rent. The landlord posted an eviction notice.', ar: 'You are behind on rent. The landlord posted an eviction notice. AR' },
  ...
  'event.career.poverty_eviction.outcome.0': { en: 'He gave you two weeks to pay up.', ar: 'He gave you two weeks to pay up. AR' },
  'event.career.poverty_eviction.outcome.1': { en: 'You sold your TV and guitar. Rent paid.', ar: 'You sold your TV and guitar. Rent paid. AR' },
  'event.career.royal_duty': { en: 'You are required to attend a state banquet. Boring but expected.', ar: 'You are required to attend a state banquet. Boring but expected. AR' },
  'event.career.royal_scandal': { en: 'The press caught you doing something embarrassing at a private club.', ar: 'The press caught you doing something embarrassing at a private club. AR' },
  ...
  'event.career.royal_scandal.outcome.0': { en: 'Damage control. The tabloids move on.', ar: 'Damage control. The tabloids move on. AR' },
  'event.career.royal_scandal.outcome.1': { en: 'The story grew. You are memed worldwide.', ar: 'The story grew. You are memed worldwide. AR' },
  'event.career.sports_championship': { en: 'It\'s the Championship Game! The score is tied.', ar: 'It\'s the Championship Game! The score is tied. AR' },
  ...
  'event.career.sports_championship.outcome.0': { en: 'Teammate scored! WE WON!', ar: 'Teammate scored! WE WON! AR' },
  'event.career.sports_championship.outcome.1': { en: 'You scored the winning point! MVP!', ar: 'You scored the winning point! MVP! AR' },
  'event.career.sports_injury': { en: 'You felt a pop in your knee during practice.', ar: 'You felt a pop in your knee during practice. AR' },
  'event.career.teen_breakup': { en: 'Your high school sweetheart dumped you for the quarterback.', ar: 'Your high school sweetheart dumped you for the quarterback. AR' },
  'event.career.teen_college_letter': { en: 'Your dream university sent a letter. Acceptance or rejection?', ar: 'Your dream university sent a letter. Acceptance or rejection? AR' },
  ...
  'event.career.teen_college_letter.outcome.0': { en: 'You got in! Tears of joy.', ar: 'You got in! Tears of joy. AR' },
  'event.career.teen_college_letter.outcome.1': { en: 'You are too nervous to look.', ar: 'You are too nervous to look. AR' },
  'event.career.teen_driving': { en: 'You saved up and bought your first car. It is a 1998 Honda Civic with 200k miles.', ar: 'You saved up and bought your first car. It is a 1998 Honda Civic with 200k miles. AR' },
  'event.career.teen_dye_hair': { en: 'You dyed your hair bright blue. Your mom is furious.', ar: 'You dyed your hair bright blue. Your mom is furious. AR' },
  'event.career.teen_exam_stress': { en: 'Final exams are next week and you have barely studied.', ar: 'Final exams are next week and you have barely studied. AR' },
  'event.career.teen_part_time_job': { en: 'The local pizza place is hiring. Do you want a part-time job?', ar: 'The local pizza place is hiring. Do you want a part-time job? AR' },
  ...
  'event.career.teen_part_time_job.outcome.0': { en: 'You are making minimum wage, but it is your own money!', ar: 'You are making minimum wage, but it is your own money! AR' },
  'event.career.teen_part_time_job.outcome.1': { en: 'You aced your classes.', ar: 'You aced your classes. AR' },
  'event.career.wealth_donation': { en: 'A charity asks you to make a significant donation.', ar: 'A charity asks you to make a significant donation. AR' },
  ...
  'event.career.wealth_donation.outcome.0': { en: 'You changed lives. Feels amazing.', ar: 'You changed lives. Feels amazing. AR' },
  'event.career.wealth_donation.outcome.1': { en: 'Your bank account is safe.', ar: 'Your bank account is safe. AR' },
  'event.career.wealth_investment_offer': { en: 'A private equity firm offers you an exclusive investment opportunity.', ar: 'A private equity firm offers you an exclusive investment opportunity. AR' },
  ...
  'event.career.wealth_investment_offer.outcome.0': { en: 'The IPO was a massive success!', ar: 'The IPO was a massive success! AR' },
  'event.career.wealth_investment_offer.outcome.1': { en: 'It soared without you. Regret.', ar: 'It soared without you. Regret. AR' },
  'event.career.ya_city_discovery': { en: 'You discovered a hidden gem of a café in your neighborhood.', ar: 'You discovered a hidden gem of a café in your neighborhood. AR' },
  'event.career.ya_credit_card': { en: 'You checked your credit card statement. The interest is brutal.', ar: 'You checked your credit card statement. The interest is brutal. AR' },
  'event.career.ya_first_serious': { en: 'Your partner said "I love you" for the first time. Butterflies everywhere.', ar: 'Your partner said "I love you" for the first time. Butterflies everywhere. AR' },
  'event.career.ya_fitness_journey': { en: 'You are tired of feeling out of shape. A gym opened near your place.', ar: 'You are tired of feeling out of shape. A gym opened near your place. AR' },
  ...
  'event.career.ya_fitness_journey.outcome.0': { en: 'Six months later, you barely recognize yourself!', ar: 'Six months later, you barely recognize yourself! AR' },
  'event.career.ya_fitness_journey.outcome.1': { en: 'Maybe next year.', ar: 'Maybe next year. AR' },
  'event.career.ya_friend_wedding': { en: 'Your best friend just got engaged. You are happy for them, but also... single.', ar: 'Your best friend just got engaged. You are happy for them, but also... single. AR' },
  'event.career.ya_job_interview': { en: 'You have a big job interview tomorrow. Your best shirt has a stain.', ar: 'You have a big job interview tomorrow. Your best shirt has a stain. AR' },
  ...
  'event.career.ya_job_interview.outcome.0': { en: 'You nailed the interview! They loved your confidence.', ar: 'You nailed the interview! They loved your confidence. AR' },
  'event.career.ya_job_interview.outcome.1': { en: 'They noticed. You did not get the job.', ar: 'They noticed. You did not get the job. AR' },
  'event.career.ya_late_night_existential': { en: 'It is 2 AM and you are wide awake questioning every life choice you ever made.', ar: 'It is 2 AM and you are wide awake questioning every life choice you ever made. AR' },
  'event.career.ya_learning_cook': { en: 'Eating out is draining your wallet. Time to learn to cook.', ar: 'Eating out is draining your wallet. Time to learn to cook. AR' },
  'event.career.ya_learning_cook.choice.0': { en: 'Take a cooking class', ar: 'Take a cooking class AR' },
  'event.career.ya_learning_cook.choice.1': { en: 'YouTube tutorials', ar: 'YouTube tutorials AR' },
  'event.career.ya_learning_cook.outcome.0': { en: 'You can now make a mean spaghetti carbonara!', ar: 'You can now make a mean spaghetti carbonara! AR' },
  'event.career.ya_learning_cook.outcome.1': { en: 'You burnt the rice. But the omelets are getting better.', ar: 'You burnt the rice. But the omelets are getting better. AR' },
  'event.career.ya_moving_home': { en: 'Money is tight. Your parents offered to let you move back in.', ar: 'Money is tight. Your parents offered to let you move back in. AR' },
  ...
  'event.career.ya_moving_home.outcome.0': { en: 'Free laundry and home-cooked meals. Worth it.', ar: 'Free laundry and home-cooked meals. Worth it. AR' },
  'event.career.ya_moving_home.outcome.1': { en: 'Pride over comfort. You will make it work.', ar: 'Pride over comfort. You will make it work. AR' },
  'event.career.ya_networking': { en: 'An industry conference is in town. Great chance to network.', ar: 'An industry conference is in town. Great chance to network. AR' },
  'event.career.ya_networking.choice.0': { en: 'Attend', ar: 'Attend AR' },
  'event.career.ya_networking.choice.1': { en: 'Skip it', ar: 'Skip it AR' },
  'event.career.ya_networking.outcome.0': { en: 'You met someone who could change your career!', ar: 'You met someone who could change your career! AR' },
  'event.career.ya_networking.outcome.1': { en: 'Networking is overrated anyway.', ar: 'Networking is overrated anyway. AR' },
  'event.career.ya_online_dating': { en: 'You matched with someone amazing on a dating app. They want to meet!', ar: 'You matched with someone amazing on a dating app. They want to meet! AR' },
  ...
  'event.career.ya_online_dating.outcome.0': { en: 'It went surprisingly well. You really clicked!', ar: 'It went surprisingly well. You really clicked! AR' },
  'event.career.ya_online_dating.outcome.1': { en: 'You unmatched and regretted it immediately.', ar: 'You unmatched and regretted it immediately. AR' },
  'event.career.ya_promotion_milestone': { en: 'Your boss pulled you aside. They see leadership potential in you.', ar: 'Your boss pulled you aside. They see leadership potential in you. AR' },
  'event.career.ya_roommate': { en: 'Your roommate ate all your food again and left a mess.', ar: 'Your roommate ate all your food again and left a mess. AR' },
  'event.life.acne': { en: 'You have a terrible breakout of acne.', ar: 'You have a terrible breakout of acne. AR' },
  'event.life.alien_abduction': { en: 'A bright light wakes you up... ALIENS?!', ar: 'A bright light wakes you up... ALIENS?! AR' },
  ...
  'event.life.alien_abduction.outcome.0': { en: 'They probed you and dumped you in a cornfield.', ar: 'They probed you and dumped you in a cornfield. AR' },
  'event.life.alien_abduction.outcome.1': { en: 'They gave you knowledge of the universe.', ar: 'They gave you knowledge of the universe. AR' },
  'event.life.all_nighter': { en: 'You pulled an all-nighter to study for finals.', ar: 'You pulled an all-nighter to study for finals. AR' },
  'event.life.anniversary_forgot': { en: 'It was your anniversary yesterday... and you forgot.', ar: 'It was your anniversary yesterday... and you forgot. AR' },
  'event.life.anniversary_forgot.choice.0': { en: 'Apologize profusely', ar: 'Apologize profusely AR' },
  'event.life.anniversary_forgot.choice.1': { en: 'Pretend you didn\'t', ar: 'Pretend you didn\'t AR' },
  'event.life.anniversary_forgot.outcome.0': { en: 'You bought expensive flowers. They still mad.', ar: 'You bought expensive flowers. They still mad. AR' },
  'event.life.anniversary_forgot.outcome.1': { en: 'They saw right through you. Sleeping on couch.', ar: 'They saw right through you. Sleeping on couch. AR' },
  'event.life.annoying_coworker': { en: 'A coworker, Karen, keeps stealing your lunch.', ar: 'A coworker, Karen, keeps stealing your lunch. AR' },
  'event.life.annoying_coworker.choice.0': { en: 'Report her', ar: 'Report her AR' },
  'event.life.annoying_coworker.choice.1': { en: 'Put laxatives in it', ar: 'Put laxatives in it AR' },
  'event.life.annoying_coworker.outcome.0': { en: 'HR gave her a warning.', ar: 'HR gave her a warning. AR' },
  'event.life.annoying_coworker.outcome.1': { en: 'She ran to the bathroom screaming.', ar: 'She ran to the bathroom screaming. AR' },
  'event.life.ate_glue': { en: 'You got curious in art class and ate a stick of glue.', ar: 'You got curious in art class and ate a stick of glue. AR' },
  'event.life.backpacking': { en: 'You have an urge to backpack across Europe.', ar: 'You have an urge to backpack across Europe. AR' },
  'event.life.backpacking.choice.0': { en: 'Go ($2k)', ar: 'Go ($2k) AR' },
  'event.life.backpacking.choice.1': { en: 'Too poor', ar: 'Too poor AR' },
  'event.life.backpacking.outcome.0': { en: 'Life changing experience!', ar: 'Life changing experience! AR' },
  'event.life.backpacking.outcome.1': { en: 'Maybe next year.', ar: 'Maybe next year. AR' },
  'event.life.bad_haircut': { en: 'The barber completely messed up your hair.', ar: 'The barber completely messed up your hair. AR' },
  'event.life.bad_hip': { en: 'Your hip is aching. Rain must be coming.', ar: 'Your hip is aching. Rain must be coming. AR' },
  'event.life.bank_error': { en: 'Bank Error in your favor!', ar: 'Bank Error in your favor! AR' },
  'event.life.bingo_night': { en: 'You went to Bingo night and won the jackpot!', ar: 'You went to Bingo night and won the jackpot! AR' },
  'event.life.bird_poop': { en: 'A bird pooped directly on your head.', ar: 'A bird pooped directly on your head. AR' },
  'event.life.bribe_offer': { en: 'A shady client offers you a bribe to ignore protocol.', ar: 'A shady client offers you a bribe to ignore protocol. AR' },
  ...
  'event.life.bribe_offer.outcome.0': { en: 'You took the cash. Hope you don\'t get caught.', ar: 'You took the cash. Hope you don\'t get caught. AR' },
  'event.life.bribe_offer.outcome.1': { en: 'Your boss praised your integrity.', ar: 'Your boss praised your integrity. AR' },
  'event.life.broken_arm': { en: 'You tripped over your own feet and broke your arm.', ar: 'You tripped over your own feet and broke your arm. AR' },
  'event.life.broken_copier': { en: 'The office copier is broken again. \'PC LOAD LETTER\'?', ar: 'The office copier is broken again. \'PC LOAD LETTER\'? AR' },
  'event.life.bullied': { en: 'A bully made fun of your shoes at school.', ar: 'A bully made fun of your shoes at school. AR' },
  'event.life.business_trip': { en: 'Boss wants you to go on a boring conference trip to Ohio.', ar: 'Boss wants you to go on a boring conference trip to Ohio. AR' },
  'event.life.business_trip.choice.0': { en: 'Go', ar: 'Go AR' },
  'event.life.business_trip.choice.1': { en: 'Fake sick', ar: 'Fake sick AR' },
  'event.life.business_trip.outcome.0': { en: 'You earned a per diem bonus.', ar: 'You earned a per diem bonus. AR' },
  'event.life.business_trip.outcome.1': { en: 'You stayed home and watched Netflix.', ar: 'You stayed home and watched Netflix. AR' },
  'event.life.cheating_test': { en: 'You didn\'t study for your math test. Do you want to cheat?', ar: 'You didn\'t study for your math test. Do you want to cheat? AR' },
  ...
  'event.life.cheating_test.outcome.0': { en: 'You got caught! Detention.', ar: 'You got caught! Detention. AR' },
  'event.life.cheating_test.outcome.1': { en: 'You managed to scrape a C-.', ar: 'You managed to scrape a C-. AR' },
  'event.life.chest_pain': { en: 'You are experiencing severe chest pains.', ar: 'You are experiencing severe chest pains. AR' },
  'event.life.chicken_pox': { en: 'You caught the Chicken Pox. You are incredibly itchy.', ar: 'You caught the Chicken Pox. You are incredibly itchy. AR' },
  'event.life.child_drawing': { en: 'Your child drew a picture of you. It looks like a potato.', ar: 'Your child drew a picture of you. It looks like a potato. AR' },
  'event.life.class_clown': { en: 'You made the whole class laugh.', ar: 'You made the whole class laugh. AR' },
  'event.life.coffee_spill': { en: 'You spilled hot coffee all over your white shirt.', ar: 'You spilled hot coffee all over your white shirt. AR' },
  'event.life.cold': { en: 'You have caught a nasty cold.', ar: 'You have caught a nasty cold. AR' },
  'event.life.crush_reject': { en: 'You worked up the courage to ask your crush out... and they laughed at you.', ar: 'You worked up the courage to ask your crush out... and they laughed at you. AR' },
  'event.life.crypto_scam': { en: 'A \'friend\' tells you about a guaranteed crypto coin that will moon.', ar: 'A \'friend\' tells you about a guaranteed crypto coin that will moon. AR' },
  'event.life.crypto_scam.choice.0': { en: 'Invest $1k', ar: 'Invest $1k AR' },
  'event.life.crypto_scam.choice.1': { en: 'Ignore', ar: 'Ignore AR' },
  'event.life.crypto_scam.outcome.0': { en: 'It was a rug pull! You lost it all.', ar: 'It was a rug pull! You lost it all. AR' },
  'event.life.crypto_scam.outcome.1': { en: 'Smart move. It crashed to zero.', ar: 'Smart move. It crashed to zero. AR' },
  'event.life.double_rainbow': { en: 'You saw a double rainbow! What does it mean?', ar: 'You saw a double rainbow! What does it mean? AR' },
  'event.life.driving_test': { en: 'It\'s time for your driving test!', ar: 'It\'s time for your driving test! AR' },
  'event.life.driving_test.choice.0': { en: 'Take test', ar: 'Take test AR' },
  'event.life.driving_test.choice.1': { en: 'Skip it', ar: 'Skip it AR' },
  'event.life.driving_test.outcome.0': { en: 'You passed! License acquired.', ar: 'You passed! License acquired. AR' },
  'event.life.driving_test.outcome.1': { en: 'You\'re stuck riding the bus.', ar: 'You\'re stuck riding the bus. AR' },
  'event.life.early_bird': { en: 'You ate dinner at 4:30 PM to get the Early Bird Special.', ar: 'You ate dinner at 4:30 PM to get the Early Bird Special. AR' },
  'event.life.eat_vegetables': { en: 'Your parents are forcing you to eat broccoli. It smells like feet.', ar: 'Your parents are forcing you to eat broccoli. It smells like feet. AR' },
  'event.life.eat_vegetables.choice.0': { en: 'Eat it', ar: 'Eat it AR' },
  'event.life.eat_vegetables.choice.1': { en: 'Throw it', ar: 'Throw it AR' },
  'event.life.eat_vegetables.outcome.0': { en: 'You choked it down. Gross.', ar: 'You choked it down. Gross. AR' },
  'event.life.eat_vegetables.outcome.1': { en: 'You threw it on the floor! Timeout!', ar: 'You threw it on the floor! Timeout! AR' },
  'event.life.family_vacation': { en: 'Your family went on a trip to Disney World!', ar: 'Your family went on a trip to Disney World! AR' },
  'event.life.find_contraband': { en: 'You found a bag of white powder on the park bench.', ar: 'You found a bag of white powder on the park bench. AR' },
  ...
  'event.life.find_contraband.outcome.0': { en: 'You sold it to a shady guy.', ar: 'You sold it to a shady guy. AR' },
  'event.life.find_contraband.outcome.1': { en: 'You walked away quickly.', ar: 'You walked away quickly. AR' },
  'event.life.first_apartment': { en: 'You moved into your first cheap apartment. It has roaches.', ar: 'You moved into your first cheap apartment. It has roaches. AR' },
  'event.life.first_kiss': { en: 'You had your first kiss behind the bleachers.', ar: 'You had your first kiss behind the bleachers. AR' },
  'event.life.first_zit': { en: 'A massive zit appeared on your nose right before school.', ar: 'A massive zit appeared on your nose right before school. AR' },
  'event.life.food_poisoning': { en: 'That sushi smelled funny. Now you are puking.', ar: 'That sushi smelled funny. Now you are puking. AR' },
  'event.life.found_money': { en: 'You found $100 on the street!', ar: 'You found $100 on the street! AR' },
  'event.life.found_phone': { en: 'You found an iPhone on a park bench.', ar: 'You found an iPhone on a park bench. AR' },
  'event.life.found_phone.choice.0': { en: 'Return it', ar: 'Return it AR' },
  'event.life.found_phone.choice.1': { en: 'Keep it', ar: 'Keep it AR' },
  'event.life.found_phone.outcome.0': { en: 'The owner gave you $20 reward!', ar: 'The owner gave you $20 reward! AR' },
  'event.life.found_phone.outcome.1': { en: 'It\'s locked, but you sold it for parts.', ar: 'It\'s locked, but you sold it for parts. AR' },
  'event.life.found_twenty': { en: 'You found a $20 bill in your old jeans.', ar: 'You found a $20 bill in your old jeans. AR' },
  'event.life.found_wallet': { en: 'You found a loaded wallet on the sidewalk. It has $200 and an ID.', ar: 'You found a loaded wallet on the sidewalk. It has $200 and an ID. AR' },
  ...
  'event.life.found_wallet.outcome.0': { en: 'The owner was so grateful!', ar: 'The owner was so grateful! AR' },
  'event.life.found_wallet.outcome.1': { en: 'Finders keepers!', ar: 'Finders keepers! AR' },
  'event.life.frat_party': { en: 'You went to a wild frat party last night.', ar: 'You went to a wild frat party last night. AR' },
  'event.life.friend_loan': { en: 'Your friend Steve wants to borrow $500 for his \'revolutionary\' app idea.', ar: 'Your friend Steve wants to borrow $500 for his \'revolutionary\' app idea. AR' },
  'event.life.friend_loan.choice.0': { en: 'Lend money', ar: 'Lend money AR' },
  'event.life.friend_loan.choice.1': { en: 'Refuse', ar: 'Refuse AR' },
  'event.life.friend_loan.outcome.0': { en: 'He says he\'ll pay you back... eventually.', ar: 'He says he\'ll pay you back... eventually. AR' },
  'event.life.friend_loan.outcome.1': { en: 'Steve is annoyed with you.', ar: 'Steve is annoyed with you. AR' },
  'event.life.grandkids_visit': { en: 'Your grandkids came to visit. They are extremely loud.', ar: 'Your grandkids came to visit. They are extremely loud. AR' },
  'event.life.house_party': { en: 'A popular kid is throwing a huge house party.', ar: 'A popular kid is throwing a huge house party. AR' },
  ...
  'event.life.house_party.outcome.1': { en: 'You aced the test, but missed the fun.', ar: 'You aced the test, but missed the fun. AR' },
  'event.life.ice_cream_truck': { en: 'The music of the Ice Cream Truck is heard in the distance.', ar: 'The music of the Ice Cream Truck is heard in the distance. AR' },
  'event.life.ice_cream_truck.choice.0': { en: 'Chase it', ar: 'Chase it AR' },
  'event.life.ice_cream_truck.choice.1': { en: 'Ignore', ar: 'Ignore AR' },
  'event.life.ice_cream_truck.outcome.0': { en: 'You got a SpongeBob popsicle.', ar: 'You got a SpongeBob popsicle. AR' },
  'event.life.ice_cream_truck.outcome.1': { en: 'You saved your money.', ar: 'You saved your money. AR' },
  'event.life.identity_theft': { en: 'Someone opened 5 credit cards in your name!', ar: 'Someone opened 5 credit cards in your name! AR' },
  'event.life.imaginary_friend': { en: 'You made a new friend named \'Mr. Sparkles\'. No one else can see him.', ar: 'You made a new friend named \'Mr. Sparkles\'. No one else can see him. AR' },
  'event.life.inLaw_visit': { en: 'Your in-laws are coming to visit for the weekend. They hate your cooking.', ar: 'Your in-laws are coming to visit for the weekend. They hate your cooking. AR' },
  'event.life.junkie_neighbor': { en: 'Your neighbor is asking for \'sugar\' at 3 AM. They look rough.', ar: 'Your neighbor is asking for \'sugar\' at 3 AM. They look rough. AR' },
  'event.life.jury_duty': { en: 'You have been summoned for Jury Duty.', ar: 'You have been summoned for Jury Duty. AR' },
  'event.life.jury_duty.choice.0': { en: 'Serve', ar: 'Serve AR' },
  'event.life.jury_duty.choice.1': { en: 'Skip it', ar: 'Skip it AR' },
  'event.life.jury_duty.outcome.0': { en: 'You did your civic duty.', ar: 'You did your civic duty. AR' },
  'event.life.jury_duty.outcome.1': { en: 'You threw the letter in the trash.', ar: 'You threw the letter in the trash. AR' },
  'event.life.layoff_rumors': { en: 'There are rumors of layoffs in your department.', ar: 'There are rumors of layoffs in your department. AR' },
  'event.life.lost_in_store': { en: 'You got lost in the grocery store! The intercom called your name.', ar: 'You got lost in the grocery store! The intercom called your name. AR' },
  'event.life.lost_tooth': { en: 'You lost a baby tooth! The Tooth Fairy left $5.', ar: 'You lost a baby tooth! The Tooth Fairy left $5. AR' },
  'event.life.lottery_find': { en: 'A gust of wind blew a lottery ticket right into your face. It\'s a winner!', ar: 'A gust of wind blew a lottery ticket right into your face. It\'s a winner! AR' },
  'event.life.lottery_win_small': { en: 'You won $5,000 in a scratch-off lottery!', ar: 'You won $5,000 in a scratch-off lottery! AR' },
  'event.life.math_tutor': { en: 'Your parents hired a math tutor because you\'re failing.', ar: 'Your parents hired a math tutor because you\'re failing. AR' },
  'event.life.memory_slip': { en: 'You walked into a room and completely forgot why you were there.', ar: 'You walked into a room and completely forgot why you were there. AR' },
  'event.life.migraine': { en: 'You have a splitting migraine.', ar: 'You have a splitting migraine. AR' },
  'event.life.office_prank': { en: 'Someone put your stapler in Jell-O. Classic.', ar: 'Someone put your stapler in Jell-O. Classic. AR' },
  'event.life.office_prank.choice.0': { en: 'Laugh', ar: 'Laugh AR' },
  'event.life.office_prank.choice.1': { en: 'Rage', ar: 'Rage AR' },
  'event.life.office_prank.outcome.0': { en: 'It was pretty funny.', ar: 'It was pretty funny. AR' },
  'event.life.office_prank.outcome.1': { en: 'You yelled at the whole office.', ar: 'You yelled at the whole office. AR' },
  'event.life.office_romance': { en: 'A cute coworker is flirting with you.', ar: 'A cute coworker is flirting with you. AR' },
  'event.life.office_romance.choice.0': { en: 'Flirt back', ar: 'Flirt back AR' },
  'event.life.office_romance.choice.1': { en: 'Keep it professional', ar: 'Keep it professional AR' },
  'event.life.office_romance.outcome.0': { en: 'You have a new work spouse!', ar: 'You have a new work spouse! AR' },
  'event.life.office_romance.outcome.1': { en: 'You focused on your work.', ar: 'You focused on your work. AR' },
  'event.life.parents_fighting': { en: 'Your parents are fighting loudly.', ar: 'Your parents are fighting loudly. AR' },
  'event.life.principal_office': { en: 'You got sent to the Principal\'s office for talking back.', ar: 'You got sent to the Principal\'s office for talking back. AR' },
  'event.life.prom_invite': { en: 'It\'s Prom season! Do you want to ask your crush?', ar: 'It\'s Prom season! Do you want to ask your crush? AR' },
  'event.life.prom_invite.choice.0': { en: 'Ask them!', ar: 'Ask them! AR' },
  'event.life.prom_invite.choice.1': { en: 'Stay home', ar: 'Stay home AR' },
  'event.life.prom_invite.outcome.0': { en: 'They said YES! Best night ever.', ar: 'They said YES! Best night ever. AR' },
  'event.life.prom_invite.outcome.1': { en: 'You played video games all night.', ar: 'You played video games all night. AR' },
  'event.life.retirement_hobby': { en: 'You\'re bored in retirement. Pick a hobby?', ar: 'You\'re bored in retirement. Pick a hobby? AR' },
  ...
  'event.life.retirement_hobby.outcome.0': { en: 'Your tomatoes are thriving!', ar: 'Your tomatoes are thriving! AR' },
  'event.life.retirement_hobby.outcome.1': { en: 'You saw a rare Blue Jay.', ar: 'You saw a rare Blue Jay. AR' },
  'event.life.scam_call': { en: 'Someone called claiming to be the IRS demanding gift cards.', ar: 'Someone called claiming to be the IRS demanding gift cards. AR' },
  ...
  'event.life.school_play': { en: 'You got the lead role in the school play!', ar: 'You got the lead role in the school play! AR' },
  'event.life.scraped_knee': { en: 'You fell off your bike and scraped your knee.', ar: 'You fell off your bike and scraped your knee. AR' },
  'event.life.shoplifting_dare': { en: 'Your \'friends\' dare you to steal a candy bar.', ar: 'Your \'friends\' dare you to steal a candy bar. AR' },
  ...
  'event.life.shoplifting_dare.outcome.0': { en: 'You did it. The rush was intense.', ar: 'You did it. The rush was intense. AR' },
  'event.life.shoplifting_dare.outcome.1': { en: 'They called you a wimp.', ar: 'They called you a wimp. AR' },
  'event.life.skip_school': { en: 'Your friends want to skip school to go to the mall.', ar: 'Your friends want to skip school to go to the mall. AR' },
  ...
  'event.life.skip_school.outcome.0': { en: 'You had a blast, but missed a test.', ar: 'You had a blast, but missed a test. AR' },
  'event.life.skip_school.outcome.1': { en: 'You learned about photosynthesis. Yay.', ar: 'You learned about photosynthesis. Yay. AR' },
  'event.life.sneak_out': { en: 'There\'s a concert tonight. Do you sneak out?', ar: 'There\'s a concert tonight. Do you sneak out? AR' },
  'event.life.sneak_out.choice.0': { en: 'Sneak out', ar: 'Sneak out AR' },
  'event.life.sneak_out.choice.1': { en: 'Stay home', ar: 'Stay home AR' },
  'event.life.sneak_out.outcome.0': { en: 'It was awesome! Detailed evaded parents.', ar: 'It was awesome! Detailed evaded parents. AR' },
  'event.life.sneak_out.outcome.1': { en: 'You have FOMO.', ar: 'You have FOMO. AR' },
  'event.life.solicitor': { en: 'A door-to-door salesman is trying to sell you magazines.', ar: 'A door-to-door salesman is trying to sell you magazines. AR' },
  ...
  'event.life.stray_dog': { en: 'You found a stray dog on the way home! Can you keep it?', ar: 'You found a stray dog on the way home! Can you keep it? AR' },
  'event.life.stray_dog.choice.0': { en: 'Beg parents', ar: 'Beg parents AR' },
  'event.life.stray_dog.choice.1': { en: 'Leave it', ar: 'Leave it AR' },
  'event.life.stray_dog.outcome.0': { en: 'They said YES! You named him Buster.', ar: 'They said YES! You named him Buster. AR' },
  'event.life.stray_dog.outcome.1': { en: 'You walked away feeling sad.', ar: 'You walked away feeling sad. AR' },
  'event.life.studied_hard': { en: 'You studied hard at school.', ar: 'You studied hard at school. AR' },
  'event.life.teacher_scolded': { en: 'Your teacher scolded you in front of everyone.', ar: 'Your teacher scolded you in front of everyone. AR' },
  'event.life.team_building': { en: 'Mandatory team building exercise: Trust Falls.', ar: 'Mandatory team building exercise: Trust Falls. AR' },
  ...
  'event.life.team_building.outcome.1': { en: 'You hid in the bathroom.', ar: 'You hid in the bathroom. AR' },
  'event.life.technophobia': { en: 'You can\'t figure out how to work the new TV remote.', ar: 'You can\'t figure out how to work the new TV remote. AR' },
  'event.life.time_traveler': { en: 'A person in a silver suit appears and asks: \'WHAT YEAR IS IT?!\'', ar: 'A person in a silver suit appears and asks: \'WHAT YEAR IS IT?!\' AR' },
  ...
  'event.life.time_traveler.outcome.0': { en: 'They typed it into a watch and vanished.', ar: 'They typed it into a watch and vanished. AR' },
  'event.life.time_traveler.outcome.1': { en: 'You ran deeply into the night.', ar: 'You ran deeply into the night. AR' },
  'event.life.traffic_jam': { en: 'Stuck in brutal traffic on the way to work.', ar: 'Stuck in brutal traffic on the way to work. AR' },
  'event.life.treehouse_build': { en: 'Your dad built a treehouse in the backyard!', ar: 'Your dad built a treehouse in the backyard! AR' },
  'event.life.vape_offer': { en: 'The cool kids are vaping in the bathroom. They offer you a hit.', ar: 'The cool kids are vaping in the bathroom. They offer you a hit. AR' },
  'event.life.vape_offer.choice.0': { en: 'Try it', ar: 'Try it AR' },
  'event.life.vape_offer.choice.1': { en: 'Refuse', ar: 'Refuse AR' },
  'event.life.vape_offer.outcome.0': { en: 'You coughed everywhere, but they think you\'re cool.', ar: 'You coughed everywhere, but they think you\'re cool. AR' },
  'event.life.vape_offer.outcome.1': { en: 'They called you a nerd.', ar: 'They called you a nerd. AR' },
  'event.life.viral_video': { en: 'You filmed a funny video of your cat. Post it?', ar: 'You filmed a funny video of your cat. Post it? AR' },
  'event.life.viral_video.choice.0': { en: 'Post it!', ar: 'Post it! AR' },
  'event.life.viral_video.choice.1': { en: 'Delete it', ar: 'Delete it AR' },
  'event.life.viral_video.outcome.0': { en: 'It went viral! 500k views!', ar: 'It went viral! 500k views! AR' },
  'event.life.viral_video.outcome.1': { en: 'Probably for the best.', ar: 'Probably for the best. AR' },
  'event.life.witness_crime': { en: 'You just saw a guy smashing a car window!', ar: 'You just saw a guy smashing a car window! AR' },
  ...
  'event.life.witness_crime.outcome.0': { en: 'The police arrived and thanked you.', ar: 'The police arrived and thanked you. AR' },
  'event.life.witness_crime.outcome.1': { en: 'Not your problem.', ar: 'Not your problem. AR' },
  'event.life.work_bestie': { en: 'You found a work bestie! Lunch is now fun.', ar: 'You found a work bestie! Lunch is now fun. AR' },
  'event.pandemic.pan_infected': { en: 'You have tested positive for the virus.', ar: 'You have tested positive for the virus. AR' },
  'event.pandemic.pan_lockdown': { en: 'The government has issued a strict lockdown. No leaving the house!', ar: 'The government has issued a strict lockdown. No leaving the house! AR' },
  'event.pandemic.pan_mask': { en: 'A lady in the grocery store refuses to wear a mask and is screaming.', ar: 'A lady in the grocery store refuses to wear a mask and is screaming. AR' },
  ...
  'event.pandemic.pan_mask.outcome.1': { en: 'You bought your beans and left.', ar: 'You bought your beans and left. AR' },
  'event.pandemic.pan_remote': { en: 'Your job has switched to remote work.', ar: 'Your job has switched to remote work. AR' },
  'event.seasonal.bucket_list': { en: 'You crossed off a bucket list item! Life feels complete.', ar: 'You crossed off a bucket list item! Life feels complete. AR' },
  'event.seasonal.burnout': { en: 'You\'re completely burned out. Work and life have drained all your energy.', ar: 'You\'re completely burned out. Work and life have drained all your energy. AR' },
  'event.seasonal.charity_knock': { en: 'A charity志愿者 knocked on your door. You donated what you could spare.', ar: 'A charity志愿者 knocked on your door. You donated what you could spare. AR' },
  'event.seasonal.deja_vu': { en: 'You experienced intense déjà vu. The moment felt strangely familiar.', ar: 'You experienced intense déjà vu. The moment felt strangely familiar. AR' },
  'event.seasonal.drivers_license': { en: 'You passed your driver\'s license test! Freedom awaits.', ar: 'You passed your driver\'s license test! Freedom awaits. AR' },
  'event.seasonal.failed_drivers_test': { en: 'You failed your driver\'s license test. Parallel parking is impossible.', ar: 'You failed your driver\'s license test. Parallel parking is impossible. AR' },
  'event.seasonal.fall_harvest': { en: 'You visited a harvest festival and enjoyed fresh apple cider.', ar: 'You visited a harvest festival and enjoyed fresh apple cider. AR' },
  'event.seasonal.fall_leaves': { en: 'The autumn leaves are beautiful this year. You take a peaceful walk.', ar: 'The autumn leaves are beautiful this year. You take a peaceful walk. AR' },
  'event.seasonal.fall_weather': { en: 'A big storm is rolling in. You lose power for a day.', ar: 'A big storm is rolling in. You lose power for a day. AR' },
  'event.seasonal.first_crush': { en: 'You have a massive crush on someone. Your heart races every time you see them.', ar: 'You have a massive crush on someone. Your heart races every time you see them. AR' },
  'event.seasonal.first_sleepover': { en: 'You went to your first sleepover! You stayed up all night telling stories.', ar: 'You went to your first sleepover! You stayed up all night telling stories. AR' },
  'event.seasonal.flat_tire': { en: 'You got a flat tire on the way to an important meeting. What a day.', ar: 'You got a flat tire on the way to an important meeting. What a day. AR' },
  'event.seasonal.food_poisoning': { en: 'You got food poisoning from last night\'s dinner. Never again.', ar: 'You got food poisoning from last night\'s dinner. Never again. AR' },
  'event.seasonal.grandchild_birth': { en: 'You became a grandparent! The newest addition to the family has arrived.', ar: 'You became a grandparent! The newest addition to the family has arrived. AR' },
  'event.seasonal.housewarming': { en: 'You hosted a housewarming party. Your new home feels alive!', ar: 'You hosted a housewarming party. Your new home feels alive! AR' },
  'event.seasonal.internet_famous': { en: 'A video of you went viral! You\'re suddenly internet famous.', ar: 'A video of you went viral! You\'re suddenly internet famous. AR' },
  'event.seasonal.lost_pet': { en: 'Your pet ran away! You searched everywhere but couldn\'t find them.', ar: 'Your pet ran away! You searched everywhere but couldn\'t find them. AR' },
  'event.seasonal.lost_wallet': { en: 'You lost your wallet! Someone returned it with everything still inside.', ar: 'You lost your wallet! Someone returned it with everything still inside. AR' },
  'event.seasonal.lucky_penny': { en: 'You found a lucky penny heads up. Maybe today will be a good day!', ar: 'You found a lucky penny heads up. Maybe today will be a good day! AR' },
  'event.seasonal.neighbor_noise': { en: 'Your neighbors are being extremely loud again. You can\'t get any peace.', ar: 'Your neighbors are being extremely loud again. You can\'t get any peace. AR' },
  'event.seasonal.new_year': { en: 'Happy New Year! You reflect on the past year and set new goals.', ar: 'Happy New Year! You reflect on the past year and set new goals. AR' },
  'event.seasonal.perfect_weather': { en: 'The weather is absolutely perfect today. Not too hot, not too cold.', ar: 'The weather is absolutely perfect today. Not too hot, not too cold. AR' },
  'event.seasonal.power_outage': { en: 'A power outage plunged your neighborhood into darkness. You made the best of it with candlelight.', ar: 'A power outage plunged your neighborhood into darkness. You made the best of it with candlelight. AR' },
  'event.seasonal.prom_night': { en: 'It\'s prom night! You danced the night away and made memories to last a lifetime.', ar: 'It\'s prom night! You danced the night away and made memories to last a lifetime. AR' },
  'event.seasonal.promotion_party': { en: 'Your colleagues threw you a surprise party for your recent promotion!', ar: 'Your colleagues threw you a surprise party for your recent promotion! AR' },
  'event.seasonal.rainy_day_cozy': { en: 'It\'s a rainy day. You stayed inside with a good book and hot tea.', ar: 'It\'s a rainy day. You stayed inside with a good book and hot tea. AR' },
  'event.seasonal.random_act_of_kindness': { en: 'A stranger paid for your coffee today. Kindness is contagious!', ar: 'A stranger paid for your coffee today. Kindness is contagious! AR' },
  'event.seasonal.reconnect_old_friend': { en: 'You ran into an old friend from school. You caught up like no time had passed.', ar: 'You ran into an old friend from school. You caught up like no time had passed. AR' },
  'event.seasonal.retirement_party': { en: 'Your coworkers threw you a retirement party. You\'ll miss this place.', ar: 'Your coworkers threw you a retirement party. You\'ll miss this place. AR' },
  'event.seasonal.school_play': { en: 'You were cast in the school play! The audience gave you a standing ovation.', ar: 'You were cast in the school play! The audience gave you a standing ovation. AR' },
  'event.seasonal.science_fair': { en: 'You won first place at the science fair! Your project impressed the judges.', ar: 'You won first place at the science fair! Your project impressed the judges. AR' },
  'event.seasonal.scout_trip': { en: 'Your scout troop went camping. You learned to build a fire and tie knots.', ar: 'Your scout troop went camping. You learned to build a fire and tie knots. AR' },
  'event.seasonal.senior_health_scare': { en: 'You had a health scare. It makes you appreciate every moment.', ar: 'You had a health scare. It makes you appreciate every moment. AR' },
  'event.seasonal.spring_allergies': { en: 'Your spring allergies are acting up. You feel miserable.', ar: 'Your spring allergies are acting up. You feel miserable. AR' },
  'event.seasonal.spring_cleaning': { en: 'You did some spring cleaning and found $50 in an old coat.', ar: 'You did some spring cleaning and found $50 in an old coat. AR' },
  'event.seasonal.spring_flowers': { en: 'Spring is in the air! Flowers are blooming everywhere.', ar: 'Spring is in the air! Flowers are blooming everywhere. AR' },
  'event.seasonal.strange_encounter': { en: 'You met someone who looks exactly like you. Strangest thing that ever happened.', ar: 'You met someone who looks exactly like you. Strangest thing that ever happened. AR' },
  'event.seasonal.summer_heatwave': { en: 'A brutal heatwave has hit your area. Stay hydrated!', ar: 'A brutal heatwave has hit your area. Stay hydrated! AR' },
  'event.seasonal.summer_romance': { en: 'You had a summer fling! Nothing serious, but it was fun.', ar: 'You had a summer fling! Nothing serious, but it was fun. AR' },
  'event.seasonal.summer_vacation': { en: 'You took a summer vacation to the beach!', ar: 'You took a summer vacation to the beach! AR' },
  'event.seasonal.surprise_gift': { en: 'You received a surprise gift in the mail! It\'s from an anonymous admirer.', ar: 'You received a surprise gift in the mail! It\'s from an anonymous admirer. AR' },
  'event.seasonal.teen_stress': { en: 'The pressure of school and social life is overwhelming you.', ar: 'The pressure of school and social life is overwhelming you. AR' },
  'event.seasonal.winter_blues': { en: 'The short days are getting to you. You feel a bit depressed.', ar: 'The short days are getting to you. You feel a bit depressed. AR' },
  'event.seasonal.winter_holidays': { en: 'The holiday season is here! You exchange gifts with loved ones.', ar: 'The holiday season is here! You exchange gifts with loved ones. AR' },
  'event.seasonal.winter_snow': { en: 'A massive snowstorm has blanketed the city. Everything is closed.', ar: 'A massive snowstorm has blanketed the city. Everything is closed. AR' },
};
