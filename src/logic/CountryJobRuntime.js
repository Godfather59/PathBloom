...
Person.prototype.setJob = function setJobWithCountryEconomy(jobData) {
  ...
  const salaryMultiplier = protectedCareer ? 1 : getSalaryMultiplier(countryState, rules);
  const adjustedJob = {
    ...jobData,
