...
const ICONS = {
  ...
  health: <path d="M12 21s-7-4.35-9.33-8.12C.78 9.82 2.12 6 5.72 5.35A5.2 5.2 0 0 1 12 8.16a5.2 5.2 0 0 1 6.28-2.81c3.6.65 4.94 4.47 3.05 7.53C19 16.65 12 21 12 21Z" />,
  happiness: (
    <>
