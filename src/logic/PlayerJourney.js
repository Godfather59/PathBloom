...
const GOALS = [
  {
    ...
    en: {
      ...
      body: 'Advance your life by one year.',
      cta: 'Age up',
      reward: '+2 happiness',
    },
    ar: {
      title: 'اتخذ خطوتك الأولى',
      body: 'تقدم سنة واحدة في حياتك.',
      cta: 'تقدم سنة',
      reward: '+2 سعادة',
    },
  ...
  },
  {
    ...
    reward: { smarts: 2 },
    en: {
      title: 'Explore your choices',
      body: 'Open Activities and discover what this life can become.',
      cta: 'Open Activities',
      reward: '+2 smarts',
    },
    ar: {
      title: 'استكشف اختياراتك',
      body: 'افتح الأنشطة واكتشف ما يمكن أن تصبح عليه حياتك.',
      cta: 'افتح الأنشطة',
      reward: '+2 ذكاء',
    },
    progress: person => ({
      value: person?.playerJourney?.actions?.open_activities ? 1 : 0,
      target: 1,
    }),
  },
  {
    ...
    en: {
      ...
      body: 'Complete a healthy or relaxing activity.',
      cta: 'Choose an activity',
      reward: '+3 health',
    },
    ar: {
      title: 'اعتنِ بنفسك',
      body: 'أكمل نشاطا صحيا أو مريحا.',
      cta: 'اختر نشاطا',
      reward: '+3 صحة',
    },
    progress: person => ({
      value: person?.playerJourney?.actions?.healthy_activity ? 1 : 0,
      target: 1,
    }),
  },
  {
    ...
    en: {
      ...
      body: 'Study, enroll, or reach solid school performance.',
      cta: 'Open Education',
      reward: '+3 smarts',
    },
    ar: {
      title: 'استثمر في المعرفة',
      body: 'ادرس أو سجّل أو حقق أداء دراسيا جيدا.',
      cta: 'افتح التعليم',
      reward: '+3 ذكاء',
    },
    progress: person => ({
      value:
        person?.playerJourney?.actions?.studied || Number(person?.currentSchool?.performance) >= 60
          ? 1
          : 0,
      target: 1,
    }),
  },
  {
    ...
    reward: { money: 500 },
    en: {
      title: 'Build an income',
      body: 'Get a job or earn your first meaningful income.',
      cta: 'Open Career',
      reward: '$500 bonus',
    },
    ar: {
      title: 'ابنِ دخلا',
      body: 'احصل على وظيفة أو اكسب أول دخل مهم.',
      cta: 'افتح المهنة',
      reward: 'مكافأة 500$',
    },
    progress: person => ({
  ...
  },
  {
    ...
    en: {
      title: 'Strengthen a bond',
      body: 'Build a relationship to at least 75%.',
      cta: 'Open Relationships',
      reward: '+3 happiness · +2 karma',
    },
    ar: {
      title: 'قوِّ رابطة',
      body: 'ارفع قوة إحدى العلاقات إلى 75% على الأقل.',
      cta: 'افتح العلاقات',
      reward: '+3 سعادة · +2 كارما',
    },
    progress: person => {
  ...
  },
  {
    ...
    reward: { money: 750 },
    en: {
      title: 'Create a safety buffer',
      body: 'Reach $10,000 in cash with no overdue personal debt.',
      cta: 'Review your income',
      reward: '$750 bonus',
    },
    ar: {
      title: 'كوّن احتياطيا ماليا',
      body: 'امتلك 10,000$ نقدا من دون دين شخصي متأخر.',
      cta: 'راجع دخلك',
      reward: 'مكافأة 750$',
    },
    progress: person => ({
  ...
  },
  {
    ...
    reward: { happiness: 4 },
    en: {
      title: 'Own part of your future',
      body: 'Buy your first asset or investment.',
      cta: 'Open Assets',
      reward: '+4 happiness',
    },
    ar: {
      title: 'امتلك جزءا من مستقبلك',
      body: 'اشترِ أول أصل أو استثمار.',
      cta: 'افتح الممتلكات',
      reward: '+4 سعادة',
    },
    progress: person => ({
...
const UNLOCK_TIPS = [
  {
    ...
    en: {
      title: 'Education is available',
      body: 'School performance now shapes future careers.',
      icon: '🎓',
    },
    ar: {
      title: 'أصبح التعليم متاحا',
      body: 'يؤثر أداؤك الدراسي الآن في المهن المستقبلية.',
      icon: '🎓',
    },
  },
  {
    ...
    en: {
      title: 'Relationships are getting deeper',
      body: 'Memories, trust, promises, and conflict now matter more.',
      icon: '🤝',
    },
    ar: {
      title: 'أصبحت العلاقات أعمق',
      body: 'للذكريات والثقة والوعود والخلافات أهمية أكبر الآن.',
      icon: '🤝',
    },
  },
  {
    ...
    en: {
      title: 'Adult life unlocked',
      body: 'Careers, assets, travel, politics, and more are now open.',
      icon: '🔓',
    },
    ar: {
      title: 'فُتحت حياة البالغين',
      body: 'أصبحت المهن والممتلكات والسفر والسياسة وغيرها متاحة.',
      icon: '🔓',
    },
  },
  {
    ...
    en: {
      title: 'Your influence is growing',
      body: 'The World screen now matters personally—your choices can shape events.',
      icon: '🌍',
    },
    ar: {
      title: 'نفوذك يتزايد',
      body: 'أصبحت شاشة العالم مهمة لك شخصيا ويمكن لاختياراتك تشكيل الأحداث.',
      icon: '🌍',
    },
  },
];
...
export function ensurePlayerJourney(person, options = {}) {
  ...
  const existing =
    person.playerJourney && typeof person.playerJourney === 'object' ? person.playerJourney : {};
...
function grantReward(person, reward = {}) {
  if (reward.money) {
    person.money = (Number(person.money) || 0) + reward.money;
  }
...
export function updatePlayerJourney(person, language = 'en') {
  ...
  if (journey.guidedEnabled) {
    ...
    for (let pass = 0; pass < 2; pass += 1) {
      ...
      if (!goal || !isGoalComplete(person, goal)) {
        break;
      }
  ...
  if (journey.tipsEnabled) {
    UNLOCK_TIPS.forEach(tip => {
      if (journey.seenUnlockIds.includes(tip.id) || !tip.condition(person)) {
        return;
      }
...
export function getJourneyView(person, language = 'en') {
  ...
  if (!goal) {
    return {
      ...
      body:
        locale === 'ar'
          ? 'أصبحت مستعدا لبناء إرثك بطريقتك.'
          : 'You are ready to build your legacy your way.',
      icon: '🌳',
    };
  }
  const progress = goal.progress(person);
